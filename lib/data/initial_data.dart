...
final List<Map<String, dynamic>> initialRulesData = [
  ...
  {
    'id': 'show_discount_code_field',
    'name': 'Mostrar Campo de Desconto',
    'description': 'Torna o campo de código de desconto visível para quantidades acima de 100.',
    'type': RuleType.visibility.name,
    'priority': RulePriority.low.value,
    'isActive': true,
    'conditions': {
      'quantity': {'operator': '>=', 'value': 100}
    },
    'targetFields': ['discountCode'],
    'showFields': true,
  },
];
